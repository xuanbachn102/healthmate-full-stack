        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-[#363636] dark:text-gray-200'>
                    ...
                    {isEdit
                        ? <input className='bg-gray-50 dark:bg-gray-800 dark:text-white max-w-52' type="text" onChange={(e) => setUserData(prev => ({ ...prev, phone: e.target.value }))} value={userData.phone} />
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-gray-600 dark:text-gray-200'>
                    ...
                    {isEdit
                        ? <select className='max-w-20 bg-gray-50 dark:bg-gray-800 dark:text-white' onChange={(e) => setUserData(prev => ({ ...prev, gender: e.target.value }))} value={userData.gender} >
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-gray-600 dark:text-gray-200'>
                    ...
                    {isEdit
                        ? <select className='max-w-32 bg-gray-50 dark:bg-gray-800 dark:text-white' onChange={(e) => setUserData(prev => ({ ...prev, bloodType: e.target.value }))} value={userData.bloodType || t('myProfile.notSpecified')} >
            ...
            <div className='mt-10'>
                ...
                {isEdit
                    ? <button onClick={updateUserProfileData} className='border border-primary dark:border-primary dark:text-white px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all'>{t('myProfile.saveInfo')}</button>
                    : <button onClick={() => setIsEdit(true)} className='border border-primary dark:border-primary dark:text-white px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all'>{t('myProfile.edit')}</button>
                }
